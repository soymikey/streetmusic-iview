        ...
        return (
            <View className='index'>
				...
				<View className="tips">实现步骤，与图片背景同理，先获取到二维码文件资源，再进行二次绘制</View>
                    ...
                    <View className="component">
                        <WQRCode cid="qrcode1446" text="uQRCode" foregroundColor="#2b9939" makeOnLoad makeComplete={this.qrcode2307Complete.bind(this)} />
                    </View>
                </View>
                <View className='button' style='text-align:center'>
                    <Button
                        size='mini'
                        className='primary'
